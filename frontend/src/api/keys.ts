...
export async function create(
  ...
  if (tierData) {
    payload.preferred_tier_key = tierData.preferred_tier_key || ''
    payload.tier_fallback_enabled = tierData.tier_fallback_enabled ?? true
    payload.tier_fallback_policy = tierData.tier_fallback_policy || {}
  }
