export default {
  ...
  keys: {
    ...
    tierRouting: {
      title: '服务档位',
      description: '选择默认倍率档位，并在默认档位不可用或降级时按策略切换到其他档位。',
      preferredTier: '默认档位',
      defaultTier: '使用分组默认档位',
      groupDefault: '分组默认',
      groupDefaultWithTier: '分组默认：{tier} · {rate}x',
      default: '默认',
      fallbackStrategy: '降级策略',
      fallbackOrder: '降级顺序',
      fallbackOrderHint: '按点击顺序生成降级顺序；这里只包含主档位之后的备选档位。',
      useGroupOrder: '按分组顺序',
      noFallbackTiers: '当前没有可配置的降级档位',
      fallbackDisabledHint: '开启允许降级后可配置降级顺序和触发阈值。',
      firstTokenThreshold: '首 token 阈值(ms)',
      errorThreshold: '错误阈值',
      cooldown: '冷却秒',
      recovery: '恢复成功数',
      fallbackOn: '允许降级',
  ...
  usage: {
    ...
    requestedTier: '请求档位',
    actualTier: '实际档位',
    tierFallbackHint: '请求档位 {requested}，实际使用 {actual}',
    rate: '倍率',
    original: '原始',
    billed: '计费',
  ...
  admin: {
    ...
    dashboard: {
      ...
      requestsShort: '请求',
      tokensShort: 'Token',
      leaderboardBackfillTitle: '卷王榜手动补数',
      leaderboardBackfillHint: '从所选日期起补齐已结束的日榜、周榜、月榜快照。',
      leaderboardBackfillAction: '补榜单快照',
      leaderboardBackfilling: '补数中...',
      leaderboardBackfillConfirm: '确认从 {date} 开始补齐卷王榜历史快照？',
      leaderboardBackfillSuccess: '补数完成：扫描 {periods} 个周期，写入 {rows} 条快照行',
      leaderboardBackfillLastResult: '上次补数：扫描 {periods} 个周期，写入 {rows} 条快照行',
      leaderboardBackfillDateRequired: '请选择补数开始日期',
      leaderboardBackfillFailed: '卷王榜补数失败',
      last7Days: '近 7 天',
      noUsageRecords: '暂无使用记录',
    ...
    users: {
      ...
      leaderboardRemove: '移出卷王榜',
      leaderboardBan: '禁止参加卷王榜',
      leaderboardUnban: '解除榜单禁止',
      leaderboardRemoved: '已将用户移出卷王榜',
      leaderboardBanned: '已禁止用户参加卷王榜',
      leaderboardUnbanned: '已解除用户榜单禁止',
      failedToUpdateLeaderboard: '更新榜单状态失败',
    ...
    groups: {
      ...
      rateTiers: {
        short: '倍率档位',
        title: '分组倍率档位',
        description: '为 OpenAI 分组配置 PRO、Plus、Pro2 等服务档位；同档位内仍按账号优先级和负载调度。',
        add: '添加档位',
        empty: '暂无倍率档位',
        default: '默认',
        disabled: '禁用',
        ...
        notConfigured: '未配置',
        selectKey: '选择档位',
        keySelectHint: '从预设档位中选择，避免手输 key 出错',
        used: '已使用',
        customKey: '历史自定义 Key',
        accountConfiguredKey: '账号已配置',
        noAvailableKey: '没有可添加的档位',
        fallbackPolicy: '降级策略',
        fallbackOrderHint: '这是整个分组唯一的降级顺序；为空时按档位顺序兜底。',
        useTierOrder: '按档位顺序',
        noFallbackTiers: '至少需要两个档位才可配置降级顺序',
        triggerConfigured: '阈值已配置',
        autoOrderHint: '档位顺序自动保存',
        moveUp: '上移',
        moveDown: '下移',
        saved: '倍率档位已保存',
        columns: {
        ...
        errors: {
          keyRequired: '档位 Key 不能为空',
          duplicateKey: '档位 Key 不能重复',
          invalidMultiplier: '倍率必须大于等于 0',
          oneDefault: '必须且只能设置一个默认档位'
        }
      },
      rpmOverrides: '专属 RPM',
    ...
    subscriptions: {
      ...
      refreshQuotaByValidity: '扣期刷新',
      refreshQuotaByValidityTitle: '扣有效期刷新额度',
      refreshQuotaByValidityConfirm: "为 '{user}' 提前刷新一个已用尽的额度窗口吗？这会扣减当前窗口剩余时间对应的有效期，不是免费重置。",
      refreshingQuotaByValidity: '刷新中...',
      refreshQuotaByValiditySuccess: '额度刷新成功',
      refreshQuotaByValidityFailed: '额度刷新失败',
      refreshQuotaNotEligible: '当前窗口暂不可刷新',
      refreshWindow: '刷新窗口',
      deductValidity: '扣减剩余窗口时间',
      newExpiration: '新到期时间',
    ...
    accounts: {
      ...
      privacyUnset: '未设置',
      allImageGenerationSupport: '全部生图能力',
      supportsImageGeneration: '支持生图',
      notSupportsImageGeneration: '不支持生图',
      supportsImageGenerationHint: '开启后，该 OpenAI 账号可承接图片生成请求。',
      bulkSupportsImageGenerationHint: '仅建议批量应用到 OpenAI OAuth/API Key 账号。',
      ...
      serviceTierKey: '服务档位 Key',
      serviceTierKeyHint: '仅 OpenAI 账号生效，需要和分组倍率档位 Key 一致，例如 pro、plus、pro2。留空表示传统未分档账号。',
      expiresAt: '过期时间',
    ...
    settings: {
      ...
      site: {
        ...
        headerContactLabel: '顶部联系方式文字',
        headerContactLabelPlaceholder: '例如：TG 群 / QQ 群 123456',
        headerContactLabelHint: '填写后会在顶部导航中间显示一个联系入口',
        headerContactUrl: '顶部联系方式链接',
        headerContactUrlPlaceholder: 'https://t.me/example 或 https://qm.qq.com/q/...',
        headerContactUrlHint: '仅支持 http/https 链接。文字和链接都填写后才展示。',
        siteLogo: '站点Logo',
        uploadImage: '上传图片',
        remove: '移除',
  ...
  version: {
    ...
    customModeHint: '定制构建请合并上游到 image-capability 后重新发布',
    basedOnVersion: '基于 {version}',
    updateNow: '立即更新',
    updating: '正在更新...',
    updateComplete: '更新完成',
    updateFailed: '更新失败',
  ...
  userSubscriptions: {
    ...
    refreshQuota: '刷新额度',
    refreshQuotaTitle: '提前刷新额度',
    refreshQuotaConfirm: '确认提前刷新 {window} 额度吗？系统会扣减当前窗口剩余时间对应的有效期，并从现在开始计算新的额度窗口。',
    confirmRefreshQuota: '确认刷新',
    refreshingQuota: '刷新中...',
    refreshQuotaSuccess: '额度刷新成功',
    refreshQuotaFailed: '额度刷新失败',
    deductValidity: '扣减剩余窗口时间',
    newExpiration: '新到期时间',
    durationDaysHours: '{days} 天 {hours} 小时',
    durationDays: '{days} 天',
    ...
    refreshReasons: {
      disabled: '刷新已关闭',
      invalid_window: '窗口无效',
      limit_not_configured: '未配置限额',
      window_not_active: '等待首次使用',
      subscription_not_active: '订阅未生效',
      natural_reset_available: '等待自然重置',
      not_exhausted: '额度未用尽',
      insufficient_validity: '有效期不足',
      subscription_unavailable: '订阅不可用'
    }
  },
  ...
  leaderboard: {
    title: '卷王榜',
    description: '查看日榜、周榜、月榜与累计榜',
    privacyHint: '自愿参加后，仅公开脱敏昵称和 Token 消耗量，不展示邮箱、用户名、用户 ID、API Key、分组或账号信息。',
    publicName: '公开显示名',
    nickname: '榜单昵称',
    nicknamePlaceholder: '留空则使用脱敏编号',
    optIn: '参加榜单',
    daily: '日榜',
    weekly: '周榜',
    monthly: '月榜',
    allTime: '累计榜',
    allTimeSubtitle: '统计当前参榜用户的历史用量',
    nextRefresh: '下次刷新',
    myRank: '我的排名',
    myRankHint: '这里展示你的个人名次与累计表现',
    notParticipating: '未参加榜单，暂不计算我的公开排名。',
    empty: '暂无参榜用量',
    requests: '{n} 次请求',
    streak: '{n} 连冠',
    champions: '累计 {n} 冠',
    ...
    silverCount: '银冠 {n}',
    bronzeCount: '铜冠 {n}',
    runnerUpStreak: '{n} 连续银冠',
    perennialRunnerUp: '万年老二',
    bestRank: '最佳 #{n}',
    appearances: '上榜 {n} 次',
    loadFailed: '加载榜单失败',
    saveFailed: '保存榜单设置失败',
