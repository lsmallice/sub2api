export default {
  ...
  admin: {
    ...
    dashboard: {
      ...
      leaderboardBackfillSuccess: '补数完成：扫描 {periods} 个周期，新增 {rows} 条快照行',
      leaderboardBackfillLastResult: '上次补数：扫描 {periods} 个周期，新增 {rows} 条快照行',
