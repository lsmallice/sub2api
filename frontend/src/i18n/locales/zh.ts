export default {
  ...
  admin: {
    ...
    subscriptions: {
      ...
      refreshQuotaByValidityConfirm: "为 '{user}' 提前刷新一个已用尽的额度窗口吗？这会扣减对应有效期，不是免费重置。",
  ...
  userSubscriptions: {
    ...
    refreshQuotaConfirm: '确认提前刷新 {window} 额度吗？系统会扣减对应有效期，并从现在开始计算新的额度窗口。',
