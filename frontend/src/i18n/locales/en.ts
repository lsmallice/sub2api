export default {
  ...
  admin: {
    ...
    subscriptions: {
      ...
      refreshQuotaByValidityConfirm: "Refresh one exhausted quota window for '{user}'? This deducts the matching subscription validity and is not a free reset.",
      ...
      deductValidity: 'Deduct validity',
  ...
  userSubscriptions: {
    ...
    refreshQuotaConfirm: 'Refresh the {window} quota early? The matching subscription validity will be deducted and the new quota window starts now.',
