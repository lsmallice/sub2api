export default {
  ...
  keys: {
    ...
    tierRouting: {
      title: 'Service tier',
      description: 'Choose the default billing tier and fall back to another tier when it is unavailable or degraded.',
      preferredTier: 'Default tier',
      defaultTier: 'Use group default tier',
      groupDefault: 'Group default',
      groupDefaultWithTier: 'Group default: {tier} · {rate}x',
      default: 'Default',
      fallbackStrategy: 'Fallback strategy',
      fallbackOrder: 'Fallback order',
      fallbackOrderHint: 'Click tiers to build fallback order. Only fallback tiers after the primary tier are included.',
      useGroupOrder: 'Use group order',
      noFallbackTiers: 'No fallback tiers are available',
      fallbackDisabledHint: 'Enable fallback to configure fallback order and trigger thresholds.',
      firstTokenThreshold: 'First token ms',
      errorThreshold: 'Error threshold',
      cooldown: 'Cooldown s',
      recovery: 'Recovery successes',
      fallbackOn: 'Fallback enabled',
      fallbackOff: 'Fallback disabled'
    },
    usage: 'Usage',
    today: 'Today',
    total: 'Last 30d',
  ...
  usage: {
    ...
    tierFallbackHint: 'Requested {requested}, actually used {actual}',
    rate: 'Rate',
    original: 'Original',
    billed: 'Billed',
  ...
  admin: {
    ...
    dashboard: {
      ...
      leaderboardBackfillSuccess: 'Backfill complete: scanned {periods} periods, wrote {rows} snapshot rows',
      leaderboardBackfillLastResult: 'Last backfill: scanned {periods} periods, wrote {rows} snapshot rows',
    ...
    groups: {
      ...
      rateTiers: {
        short: 'Rate Tiers',
        title: 'Group Rate Tiers',
        description: 'Configure OpenAI tiers such as PRO, Plus, and Pro2. Accounts inside one tier still use account priority and load scheduling.',
        add: 'Add Tier',
        empty: 'No rate tiers configured',
        default: 'Default',
        disabled: 'Disabled',
        loading: 'Loading',
        loadFailed: 'Load failed',
        notConfigured: 'Not configured',
        selectKey: 'Select tier',
        keySelectHint: 'Choose from preset tiers to avoid mistyped keys',
        used: 'Used',
        customKey: 'Legacy custom key',
        accountConfiguredKey: 'Configured on accounts',
        noAvailableKey: 'No tier keys available',
        fallbackPolicy: 'Fallback Policy',
        fallbackOrderHint: 'This is the only fallback order for the group. Empty uses the tier order.',
        useTierOrder: 'Use tier order',
        noFallbackTiers: 'At least two tiers are required to configure fallback order',
        triggerConfigured: 'Triggers configured',
        autoOrderHint: 'Tier order is saved automatically',
        moveUp: 'Move up',
        moveDown: 'Move down',
        saved: 'Rate tiers saved',
        columns: {
          key: 'Tier Key',
          name: 'Name',
          multiplier: 'Rate',
        ...
        errors: {
          keyRequired: 'Tier key is required',
          duplicateKey: 'Tier keys must be unique',
          invalidMultiplier: 'Rate multiplier must be >= 0',
          oneDefault: 'Exactly one default tier is required'
        }
      },
    ...
    subscriptions: {
      ...
      quotaResetSuccess: 'Quota reset successfully',
      failedToResetQuota: 'Failed to reset quota',
      refreshQuotaByValidity: 'Paid Refresh',
      refreshQuotaByValidityTitle: 'Refresh Quota by Deducting Validity',
      refreshQuotaByValidityConfirm: "Refresh one exhausted quota window for '{user}'? This deducts validity equal to the remaining time in the current window and is not a free reset.",
      refreshingQuotaByValidity: 'Refreshing...',
      refreshQuotaByValiditySuccess: 'Quota refreshed successfully',
      refreshQuotaByValidityFailed: 'Failed to refresh quota',
      refreshQuotaNotEligible: 'The selected window cannot be refreshed yet',
      refreshWindow: 'Refresh window',
      deductValidity: 'Deduct remaining window time',
    ...
    accounts: {
      ...
      supportsImageGeneration: 'Image capable',
      notSupportsImageGeneration: 'Not image capable',
      supportsImageGenerationHint: 'When enabled, this OpenAI account can receive image-generation requests.',
      bulkSupportsImageGenerationHint: 'Best used for OpenAI OAuth/API key accounts.',
      ...
      serviceTierKey: 'Service Tier Key',
      serviceTierKeyHint: 'OpenAI accounts only. Must match a group tier key such as pro, plus, or pro2. Empty keeps legacy unclassified behavior.',
      expiresAt: 'Expires At',
    ...
    settings: {
      ...
      site: {
        ...
        headerContactLabel: 'Header Contact Label',
        headerContactLabelPlaceholder: 'e.g., TG Group / QQ Group 123456',
        headerContactLabelHint: 'Displayed as a compact contact entry in the header navigation.',
        headerContactUrl: 'Header Contact URL',
        headerContactUrlPlaceholder: 'https://t.me/example or https://qm.qq.com/q/...',
        headerContactUrlHint: 'Only http/https links are supported. Both label and URL are required to show it.',
        siteLogo: 'Site Logo',
  ...
  userSubscriptions: {
    ...
    refreshQuotaTitle: 'Refresh Quota Early',
    refreshQuotaConfirm: 'Refresh the {window} quota early? Validity equal to the remaining time in the current window will be deducted, and the new quota window starts now.',
    confirmRefreshQuota: 'Refresh',
    refreshingQuota: 'Refreshing...',
    refreshQuotaSuccess: 'Quota refreshed successfully',
    ...
    refreshReasons: {
      ...
      limit_not_configured: 'No limit configured',
      window_not_active: 'Awaiting first use',
      subscription_not_active: 'Subscription inactive',
      natural_reset_available: 'Natural reset available',
      not_exhausted: 'Quota not exhausted',
      insufficient_validity: 'Insufficient validity',
  ...
  leaderboard: {
    ...
    description: 'Daily, weekly, monthly, and all-time token rankings',
    privacyHint: 'After you opt in, only your masked display name and token usage are shown. Email, username, user ID, API keys, groups, and accounts are never exposed.',
    publicName: 'Public name',
    nickname: 'Leaderboard nickname',
    nicknamePlaceholder: 'Leave blank for a masked code',
    optIn: 'Join leaderboard',
    daily: 'Daily',
    weekly: 'Weekly',
    monthly: 'Monthly',
    allTime: 'All-Time',
    allTimeSubtitle: 'Historical usage from current participants',
    ...
    empty: 'No opted-in usage yet',
    requests: '{n} requests',
    streak: '{n}x streak',
    champions: '{n} titles',
    goldCount: '{n} gold crowns',
    silverCount: '{n} silver crowns',
    bronzeCount: '{n} bronze crowns',
    runnerUpStreak: '{n} silver streak',
    perennialRunnerUp: 'Perennial runner-up',
    bestRank: 'Best #{n}',
