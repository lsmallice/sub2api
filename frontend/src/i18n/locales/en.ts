export default {
  ...
  keys: {
    ...
    tierRouting: {
      ...
      fallbackOrderHint: 'Comma-separated, e.g. plus,pro2. Empty uses the group tier order.',
  ...
  admin: {
    ...
    groups: {
      ...
      rateTiers: {
        ...
        description: 'Configure OpenAI group service tiers such as PRO, Plus, and Pro2. Accounts are scheduled by tier.',
        add: 'Add Tier',
