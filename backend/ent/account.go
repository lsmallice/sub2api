...
func (*Account) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case account.FieldCredentials, account.FieldExtra:
			values[i] = new([]byte)
		case account.FieldSupportsImageGeneration, account.FieldAutoPauseOnExpired, account.FieldSchedulable:
		...
		case account.FieldName, account.FieldNotes, account.FieldPlatform, account.FieldType, account.FieldServiceTierKey, account.FieldStatus, account.FieldErrorMessage, account.FieldTempUnschedulableReason, account.FieldSessionWindowStatus, account.FieldQuotaDimension:
...
func (_m *Account) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case account.FieldServiceTierKey:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field service_tier_key", values[i])
			} else if value.Valid {
				_m.ServiceTierKey = value.String
			}
		case account.FieldSupportsImageGeneration:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field supports_image_generation", values[i])
			} else if value.Valid {
				_m.SupportsImageGeneration = value.Bool
			}
...
func (_m *Account) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("service_tier_key=")
	builder.WriteString(_m.ServiceTierKey)
	builder.WriteString(", ")
	builder.WriteString("supports_image_generation=")
	builder.WriteString(fmt.Sprintf("%v", _m.SupportsImageGeneration))
	builder.WriteString(", ")
