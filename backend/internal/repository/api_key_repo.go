...
func (r *apiKeyRepository) Create(ctx context.Context, key *service.APIKey) error {
	builder := r.client.APIKey.Create().
		...
		SetPreferredTierKey(key.PreferredTierKey).
		SetTierFallbackEnabled(key.TierFallbackEnabled).
		SetTierFallbackPolicy(normalizeJSONMap(key.TierFallbackPolicy)).
...
func (r *apiKeyRepository) GetByKeyForAuth(ctx context.Context, key string) (*service.APIKey, error) {
	m, err := r.activeQuery().
		...
		Select(
			...
			apikey.FieldName,
			apikey.FieldStatus,
			apikey.FieldPreferredTierKey,
			apikey.FieldTierFallbackEnabled,
			apikey.FieldTierFallbackPolicy,
...
func apiKeyEntityToService(m *dbent.APIKey) *service.APIKey {
	...
	out := &service.APIKey{
		...
		Name:                m.Name,
		Status:              m.Status,
		PreferredTierKey:    m.PreferredTierKey,
		TierFallbackEnabled: m.TierFallbackEnabled,
		TierFallbackPolicy:  copyJSONMap(m.TierFallbackPolicy),
