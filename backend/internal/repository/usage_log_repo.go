...
const usageLogSelectColumns = "id, user_id, api_key_id, account_id, request_id, model, requested_model, upstream_model, group_id, subscription_id, input_tokens, output_tokens, cache_creation_tokens, cache_read_tokens, cache_creation_5m_tokens, cache_creation_1h_tokens, image_output_tokens, image_output_cost, input_cost, output_cost, cache_creation_cost, cache_read_cost, total_cost, actual_cost, rate_multiplier, account_rate_multiplier, billing_type, request_type, stream, openai_ws_mode, duration_ms, first_token_ms, user_agent, ip_address, image_count, image_size, image_input_size, image_output_size, image_size_source, image_size_breakdown, service_tier, reasoning_effort, inbound_endpoint, upstream_endpoint, cache_ttl_overridden, channel_id, model_mapping_chain, billing_tier, billing_mode, requested_tier_key, actual_tier_key, account_stats_cost, created_at"
...
var usageLogInsertArgTypes = [...]string{
	...
	"text",        // billing_tier
	"text",        // billing_mode
	"text",        // requested_tier_key
	"text",        // actual_tier_key
...
func prepareUsageLogInsert(log *service.UsageLog) usageLogInsertPrepared {
	...
	requestedTierKey := nullString(log.RequestedTierKey)
	actualTierKey := nullString(log.ActualTierKey)
...
func scanUsageLog(scanner interface{ Scan(...any) error }) (*service.UsageLog, error) {
	var (
		...
		requestedTierKey      sql.NullString
		actualTierKey         sql.NullString
	...
	if requestedTierKey.Valid {
		log.RequestedTierKey = &requestedTierKey.String
	}
	if actualTierKey.Valid {
		log.ActualTierKey = &actualTierKey.String
	}
