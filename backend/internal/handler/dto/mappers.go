...
func APIKeyFromService(k *service.APIKey) *APIKey {
	...
	out := &APIKey{
		...
		GroupID:             k.GroupID,
		Status:              k.Status,
		PreferredTierKey:    k.PreferredTierKey,
		TierFallbackEnabled: k.TierFallbackEnabled,
		TierFallbackPolicy:  k.TierFallbackPolicy,
...
func AccountFromServiceShallow(a *service.Account) *Account {
	...
	out := &Account{
		...
		ServiceTierKey:          a.ServiceTierKey,
		Status:                  a.Status,
...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	...
	return UsageLog{
		...
		RequestedTierKey:      l.RequestedTierKey,
		ActualTierKey:         l.ActualTierKey,
