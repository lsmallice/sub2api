					...
					"items": [
						{
							...
							"group_id": null,
							"preferred_tier_key": "",
							"tier_fallback_enabled": false,
							"tier_fallback_policy": null,
							"status": "active",
							"ip_whitelist": null,
							"ip_blacklist": null,
							"last_used_at": null,
...
func newContractDeps(t *testing.T) *contractDeps {
	...
	apiKeyService := service.NewAPIKeyService(apiKeyRepo, userRepo, groupRepo, userSubRepo, nil, nil, apiKeyCache, cfg)
...
func (stubUserSubscriptionRepo) RefreshQuotaWindow(ctx context.Context, input *service.SubscriptionQuotaRefreshPersistInput) (*service.UserSubscription, error) {
	return nil, errors.New("not implemented")
}
