...
func registerDashboardRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	dashboard := admin.Group("/dashboard")
	{
		...
		dashboard.POST("/leaderboard/backfill", h.Leaderboard.AdminBackfillSnapshots)
	}
}
...
func registerUserManagementRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	users := admin.Group("/users")
	{
		...
		users.POST("/:id/leaderboard/remove", h.Leaderboard.AdminRemoveParticipant)
		users.POST("/:id/leaderboard/ban", h.Leaderboard.AdminBanParticipant)
		users.POST("/:id/leaderboard/unban", h.Leaderboard.AdminUnbanParticipant)
...
func registerGroupRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	groups := admin.Group("/groups")
	{
		...
		groups.GET("/:id/rate-tiers", h.Admin.Group.GetGroupRateTiers)
		groups.PUT("/:id/rate-tiers", h.Admin.Group.BatchSetGroupRateTiers)
...
func registerSubscriptionRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	subscriptions := admin.Group("/subscriptions")
	{
		...
		subscriptions.POST("/:id/refresh-quota", h.Admin.Subscription.RefreshQuota)
